...
<body class="skin-default-dark fixed-layout">
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index-2.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Light Logo icon -->
                            <img src="{{ asset('imglogo-light-icon.png')}}" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
        ...
        <aside class="left-sidebar">
            <div class="d-flex no-block nav-text-box align-items-center">
                <span><img src="{{ asset('img/logo-icon.png')}}" alt="elegant admin template"></span>
                    ...
                    <ul id="sidebarnav">
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Dashboard <span class="badge badge-pill badge-cyan">4</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="index-2.html">Minimal <i class="far fa-circle text-success"></i></a></li>
                                <li><a href="index2.html">Analytical <i class="far fa-circle text-info"></i></a></li>
                                <li><a href="index3.html">Demographical <i class="far fa-circle text-danger"></i></a></li>
                                <li><a href="index4.html">Modern <i class="far fa-circle text-warning"></i></a></li>
                                <li><a href="index5.html">Cryptocurrency <i class="far fa-circle text-primary"></i></a></li>
                            </ul>
                        </li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-palette"></i><span class="hide-menu">Ui Elements <span class="badge badge-pill badge-primary text-white">25</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="ui-spinner.html">Spinner <i class="mdi mdi-application"></i></a></li>
                                <li><a href="ui-scrollspy.html">Scrollspy <i class="mdi mdi-crop-free"></i></a></li>
                                <li><a href="ui-toasts.html">Toasts <i class="mdi mdi-apple-safari"></i></a></li>
                            </ul>
                        </li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-media-right-alt"></i><span class="hide-menu">Forms</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="form-bootstrap-validation.html">Form Bootstrap Validation <i class="mdi mdi-credit-card-scan"></i></a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="steamline m-t-40">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user" src="{{ asset('img/users/1.jpg')}}"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user" src="{{ asset('img/users/2.jpg')}}"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user" src="{{ asset('img/users/3.jpg')}}"> </div>
                                        <div class="sl-right">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <!-- column -->
                        <div class="card news-slide" style="background:url(../../public/img/background/img5.jpg) center center / cover;">
                                ...
                                <div class="to-do-widget m-t-20">
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        <li class="list-group-item" data-role="task">
                                            ...
                                            <ul class="assignedto">
                                                <li><img src="{{ asset('img/users/1.jpg')}}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                                <li><img src="{{ asset('img/users/2.jpg')}}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                                <li><img src="{{ asset('img/users/3.jpg')}}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li><img src="{{ asset('img/users/4.jpg')}}" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                                        <li class="list-group-item" data-role="task">
                                            <div class="custom-control custom-checkbox">
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box">
                                    ...
                                    <ul class="chat-list">
                                        ...
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="{{ asset('img/users/2.jpg')}}" alt="user"></div>
                                            <div class="chat-content">
                                                <h5>Bianca Doe</h5>
                                        ...
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="{{ asset('img/users/3.jpg')}}" alt="user"></div>
                                            <div class="chat-content">
                    ...
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ asset('img/users/1.jpg')}}" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ asset('img/users/2.jpg')}}" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ asset('img/users/3.jpg')}}" alt="user-img" class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ asset('img/users/4.jpg')}}" alt="user-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ asset('img/users/5.jpg')}}" alt="user-img" class="img-circle"> <span>Govinda Star <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ asset('img/users/6.jpg')}}" alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ asset('img/users/7.jpg')}}" alt="user-img" class="img-circle"> <span>Hritik Roshan<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="{{ asset('img/users/8.jpg')}}" alt="user-img" class="img-circle"> <span>Pwandeep rajan <small class="text-success">online</small></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <!-- ============================================================== -->
        <footer class="footer">
            © 2019 Elegent Admin by HB Hacked
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
    ...
    <!-- ============================================================== -->
    <!--morris JavaScript -->
    <script src="{{ asset('js/dashboard/raphael/raphael.min.js')}}"></script>
    <script src="{{ asset('js/dashboard/morrisjs/morris.min.js')}}"></script>
